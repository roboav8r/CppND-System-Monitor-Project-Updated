...
long LinuxParser::Jiffies( std::vector<std::string>& Util ) { 
...
long LinuxParser::ActiveJiffies( std::vector<std::string>& Util ) {
...
long LinuxParser::IdleJiffies( std::vector<std::string>& Util ) {
